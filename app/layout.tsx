...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="de" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}><body className="min-h-full flex flex-col">
        <AppSplash /><PWARegister/><AppAnalyticsTracker/><AppExperience>{children}</AppExperience></body></html>}
