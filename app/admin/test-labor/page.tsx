...
export default async function TestLaborPage(){
 ...
 const players=(data??[]).filter(isPlayingProfile).map(p=>({id:p.id,first_name:p.first_name,last_name:p.last_name,shirt_number:p.shirt_number,image_url:p.image_url}));
