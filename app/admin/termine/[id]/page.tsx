  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <form action={updateEvent} className="club-card mt-8 grid gap-4 p-5 md:grid-cols-2 md:p-6">
        ...
        <Field label="Startzeit"><input name="time" type="time" required defaultValue={event.all_day ? "18:30" : localTime(event.starts_at)} className="admin-input" /><p className="mt-2 text-xs text-zinc-600">Bei ganztägigen Terminen wird diese Zeit ignoriert.</p></Field>
